...
const Popup: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[500px] bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4">
  ...
  return (
    <div className="min-h-[500px] bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      {/* Header */}
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white">NoScroll</h1>
              <p className="text-xs text-gray-500 dark:text-gray-400">Stay focused, stay productive</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center space-x-4">
            <span className="text-gray-600 dark:text-gray-300">
              <span className="font-medium text-primary-600 dark:text-primary-400">{pendingCount}</span> pending
            </span>
            <span className="text-gray-600 dark:text-gray-300">
          ...
          {tasks.length > 0 && (
            <button
              ...
              className="text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 px-2 py-1 rounded transition-colors"
            >
              Clear All
            </button>
          )}
